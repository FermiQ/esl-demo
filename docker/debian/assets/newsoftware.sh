...
echo "prefix='/home/drFaustroll/esl/openmpi/0.3.1'" >> rcfiles/debian-gcc-openmpi.rc
...
pushd esl-bundle
echo "prefix='/home/drFaustroll/esl/serial/0.3.1'" >> rcfiles/debian-gcc-serial.rc
